 ...
 */
function exercise_form_install_configure_form_alter(&$form, $form_state) {
 ...
 */
function exercise_install_tasks() {
  $tasks = array();

  $tasks['exercise_setup_variables'] = array(
    'display_name' => st('Set Variables'),
    'display' => FALSE,
  );

  $tasks['exercise_setup_og_permissions'] = array(
    'display_name' => st('Set Blocks'),
    'display' => FALSE,
  );

  // Run this as the last task!
  $tasks['exercise_setup_rebuild_permissions'] = array(
 ...
 */
function exercise_setup_variables() {
  $variables = array(
    // Features default export path.
    'features_default_export_path' => 'profiles/exercise/modules/custom',
    // Mime-mail.
    'mimemail_format' => 'full_html',
    'mimemail_sitestyle' => FALSE,
    'mimemail_name' => 'Exercise',
    'mimemail_mail' => 'info@exercise.com',
    // jQuery versions.
 ...
 * created.
 */
function exercise_setup_og_permissions() {
 ...
 */
function exercise_setup_blocks() {
 ...
 * installation.
 */
function exercise_setup_rebuild_permissions() {
  node_access_rebuild();
}
