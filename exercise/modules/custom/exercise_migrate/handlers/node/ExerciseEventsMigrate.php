...
/**
 * @file
 * Contains \ExerciseEventsMigrate.
 */

class ExerciseEventsMigrate extends \ExerciseMigrateBase {
  ...
  public function __construct($arguments) {
    ...
    $this
      ...
      ->sourceMigration('ExerciseCompaniesMigrate');

    $this
      ->addFieldMapping('uid', '_author')
      ->sourceMigration('ExerciseUsersMigrate');
  }
